...
public class TekeningHangMan extends Tekening {
    ...
    private void setUpVormen() {
        // Bevat de volgende vormen
        // Altijd zichtbaar
        Vorm galgBodem = new Rechthoek(new Punt(10,350), 300,40);
        galgBodem.setKleur(Color.TOMATO);
    ...
    // Arraylists beginnen vanaf 0, ni vergeten
    private int index = 4;
...
//            System.out.println("index is " + index);
            ...
            // Exception gooien zodat die de knop disabled
